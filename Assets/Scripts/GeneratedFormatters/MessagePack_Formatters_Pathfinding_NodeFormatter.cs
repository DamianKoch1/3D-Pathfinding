...
namespace MessagePack.Formatters.Pathfinding
{
    ...
    public sealed class NodeFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Pathfinding.Node>
    {


        public void Serialize(ref MessagePackWriter writer, global::Pathfinding.Node value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            writer.Write(value.isoValue);
            formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.List<global::Pathfinding.NodeIdentifier>>().Serialize(ref writer, value.neighbourIdentifiers, options);
        }
